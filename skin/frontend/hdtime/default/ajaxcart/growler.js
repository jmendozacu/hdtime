...
Growler = (function(){
	...
	return Class.create({
		initialize: function(options){
			...
			this.growler.setStyle({ position: ("absolute"), padding: "10px", "width": opt.width, "z-index": "50000" });
			if(IE==6){
			...
			this.growler.wrap( document.querySelector('.basket.top-aside') );
		}
		...
		,info: function(msg, options){
			return specialNotice(this.growler, "добавлен в корзину", options, msg, "#4ba639", "#FFF");
		}
