...
require_once rtrim(dirname(__FILE__), '/').'/../../../../Core/Catalog/Product/Export.php';

/**
 * Product base currency export
 * 
 * @category   Innoexts
 * @package    Innoexts_Shell
 * @author     Innoexts Team <developers@innoexts.com>
 */
class Innoexts_Shell_ProductBaseCurrency_Catalog_Product_BaseCurrency_Export 
...
$shell = new Innoexts_Shell_ProductBaseCurrency_Catalog_Product_BaseCurrency_Export();
$shell->run();
