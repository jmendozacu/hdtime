 ...
 */
class Innoexts_Shell_ProductBaseCurrency_Catalog_Product_Price_Tier_Export 
...
$shell = new Innoexts_Shell_ProductBaseCurrency_Catalog_Product_Price_Tier_Export();
$shell->run();
