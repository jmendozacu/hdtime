 ...
 */
class Innoexts_Shell_ProductBaseCurrency_Catalog_Product_Price_Special_Import 
    extends Innoexts_Shell_Core_Catalog_Product_Price_Special_Import 
{
    
}

$shell = new Innoexts_Shell_ProductBaseCurrency_Catalog_Product_Price_Special_Import();
$shell->run();
