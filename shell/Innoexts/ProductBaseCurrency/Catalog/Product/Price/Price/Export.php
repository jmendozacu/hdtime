 ...
 */
class Innoexts_Shell_ProductBaseCurrency_Catalog_Product_Price_Price_Export 
    extends Innoexts_Shell_Core_Catalog_Product_Price_Price_Export 
{
    
}

$shell = new Innoexts_Shell_ProductBaseCurrency_Catalog_Product_Price_Price_Export();
$shell->run();
